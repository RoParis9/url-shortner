...
describe('Url Entity', () => {
  describe('create', () => {
    ...
    it('should create a URL without user ID', () => {
      ...
      const url = Url.create(originalUrl);
    ...
    it('should throw error for invalid URL', () => {
      ...
      expect(() => Url.create(invalidUrl)).toThrow('Invalid URL format');
    });

    it('should normalize URL without protocol', () => {
      const urlWithoutProtocol = 'example.com';

      const url = Url.create(urlWithoutProtocol);
    ...
    it('should keep URL with existing protocol', () => {
      ...
      const url = Url.create(urlWithProtocol);
  ...
  describe('updateOriginalUrl', () => {
    it('should update original URL with valid format', () => {
      const url = Url.create('https://old.com');
