...
describe('User Entity', () => {
    describe('create', () => {
        ...
        it('should throw error for invalid email', () => {
            ...
            const password = 'password123';
            expect(() => user_entity_1.User.create(invalidEmail, password)).toThrow('Invalid email format');
        });
        it('should throw error for short password', () => {
            const email = 'test@example.com';
            const shortPassword = '123';
            expect(() => user_entity_1.User.create(email, shortPassword)).toThrow('Password must be at least 8 characters long');
        });
    ...
    describe('updateEmail', () => {
        it('should update email with valid format', () => {
            const user = user_entity_1.User.create('old@example.com', 'password123');
        ...
        it('should throw error for invalid email format', () => {
            const user = user_entity_1.User.create('test@example.com', 'password123');
            const invalidEmail = 'invalid-email';
    ...
    describe('updatePassword', () => {
        it('should update password with valid length', () => {
            const user = user_entity_1.User.create('test@example.com', 'oldpassword123');
...
//# sourceMappingURL=user.entity.test.js.map